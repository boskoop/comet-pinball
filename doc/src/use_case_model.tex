...
\item[Ball leaves play field:] The ball is passing the flippers and leaves the play field via the drain. The application loads a new ball in the plunger and decreases the counter of available balls by one.
