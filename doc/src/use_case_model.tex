...
\begin{enumerate}[leftmargin=3em]
	\item The \emph{Player} opens the configuration file.
	\item The \emph{Player} configures the game properties.
	\item The \emph{Player} saves the file.
	\item The \emph{Player} starts the application.
	\item The system reads the configuration from the file.
...
\section{Notes}
The use cases "Extra game" and "Extra ball" are not implemented in the current version of the program.	
